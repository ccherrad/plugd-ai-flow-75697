  ...
  const testimonials: Testimonial[] = [
    {
      ...
      comment: (
        <span>
          <img src={logo} alt="STCKD.AI" className="h-3.5 inline-block align-middle" /> has completely transformed how we handle procurement. the AI-powered anomaly detection caught pricing errors that saved us thousands in the first month alone.
        </span>
      ),
      rating: 5,
