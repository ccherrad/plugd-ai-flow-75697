  ...
  return (
    <section id="team" className="container lg:w-[75%] py-24 sm:py-32">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl md:text-4xl text-center font-bold flex items-center justify-center gap-2">
      ...
      <div className="mt-16 max-w-3xl mx-auto">
        <div className="bg-primary/5 border border-primary/10 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-sm font-medium text-foreground flex items-center justify-center gap-1">— The <img src={logo} alt="STCKD.AI" className="h-3 inline-block" /> Team</p>
        </div>
      </div>
    </section>
  );
