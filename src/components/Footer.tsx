    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-bold mb-3">PLUGD.AI</h3>
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-primary-foreground/70 mb-8">
            ...
            <a href="mailto:hello@plugd.ai" className="hover:text-primary-foreground transition-colors">
              hello@plugd.ai
            </a>
          </div>
          ...
          <div className="pt-6 border-t border-primary-foreground/10">
            <p className="text-xs text-primary-foreground/50">
              © 2024 PLUGD.AI • Currently in MVP
            </p>
          </div>
        </div>
      </div>
